...
export default function page() {
    ...
    useEffect(() => {
        axios.get(`${APIURL}/ship/order/movie-order-view`)
            .then((res) => res.data)
            .then((finalData) => {
    ...
    return (
        <>
            {/* <section className="mt-6 p-4">
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Movie Tickets</h2>
                <div className="bg-white rounded-lg shadow border border-gray-100 overflow-hidden">
                    <table className="min-w-full divide-y divide-gray-200 text-sm">
                        ...
                        <tbody id="resortMovieBody" className="divide-y divide-gray-100 bg-white"></tbody>
                    </table>
                </div>
            </section> */}

            <section className="mt-6 p-4">
                <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-3">🎬 Movie Tickets</h2>
