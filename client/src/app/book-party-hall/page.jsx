...
import PartyHallBooking from '../components/PartyHallBooking'
        ...
        <>
            ...
            <div className='p-8'>
...

                {
                    ...
                    partyHall.length > 0 ?
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="cateringItemsGrid">
                            {partyHall.map((items, index) => (
                                <PartyHallBooking items={items} index={index} />
                            ))}
                        </div>
                        :
