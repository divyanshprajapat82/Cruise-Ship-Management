        ...
        <>
            ...
            <div className='p-8'>
                <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-900 mb-2">Movie Booking - Book Your Show</h2>
                        <p className="text-gray-600">Browse and Book Movies options</p>
                    </div>
                </div>
                    ...
                    movie.length > 0 ?
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" id="cateringItemsGrid">
                            {movie.map((items, index) => (
                                <MovieBooking items={items} index={index} />
                            ))}
                        </div>
                        :
