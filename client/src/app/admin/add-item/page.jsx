            ...
            <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                ...
                <div className="p-5">
                    <div className="grid sm:grid-cols-2 grid-cols-1 gap-3">
                        <Link href={'/admin/add-movie'} className="flex flex-col items-center gap-2 p-4 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer transition-all duration-200 font-sans text-sm text-slate-900 hover:bg-blue-50 hover:border-blue-600 hover:-translate-y-0.5">
                            <MdMovieFilter className="w-6 h-6 text-blue-600" />
                            <span>Add Resort-Movie</span>
                        </Link>
                        <Link href={'/admin/add-beauty-salon'} className="flex flex-col items-center gap-2 p-4 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer transition-all duration-200 font-sans text-sm text-slate-900 hover:bg-blue-50 hover:border-blue-600 hover:-translate-y-0.5">
                            <GiMirrorMirror className="w-6 h-6 text-blue-600" />
                            <span>Add Beauty salon</span>
                        </Link>
                        <Link href={'/admin/add-fitness'} className="flex flex-col items-center gap-2 p-4 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer transition-all duration-200 font-sans text-sm text-slate-900 hover:bg-blue-50 hover:border-blue-600 hover:-translate-y-0.5">
                            <IoIosFitness className="w-6 h-6 text-blue-600" />
                            <span>Add Fitness center</span>
                        </Link>
                        <Link href={'/admin/add-party-hall'} className="flex flex-col items-center gap-2 p-4 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer transition-all duration-200 font-sans text-sm text-slate-900 hover:bg-blue-50 hover:border-blue-600 hover:-translate-y-0.5">
                        ...
                        <Link href={'/admin/add-stationery'} className="flex flex-col items-center gap-2 p-4 bg-gray-50 border border-gray-200 rounded-lg cursor-pointer transition-all duration-200 font-sans text-sm text-slate-900 hover:bg-blue-50 hover:border-blue-600 hover:-translate-y-0.5">
                            ...
                            <span>Add Stationery Items</span>
                        </Link>
