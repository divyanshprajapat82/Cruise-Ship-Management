...
export default function page() {
    ...
    let { userRole, setToken, token, profile } = useContext(loginContext)
    ...
    useEffect(() => {
        axios.get(`${APIURL}/ship/order/stationery-order-view`)
            .then((res) => res.data)
            .then((finalData) => {
        ...
        <>
            ...
            <section className="h-full bg-gray-50">
                ...
                <div className='mt-6 p-4'>
                    <h2 className="text-xl md:text-2xl font-semibold text-gray-900 mb-3">🌠 Stationery Orders</h2>
